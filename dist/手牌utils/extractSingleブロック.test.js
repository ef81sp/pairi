...
describe("単体抽出", () => {
    test("雀頭 - とれる", () => {
        const 手牌 = {
            m: ["1m", "1m", "2m", "2m", "3m"].map((s) => new 牌(s)),
            p: [],
            s: [],
    ...
    test("面子 - 刻子とれる - 字牌", () => {
        const 手牌 = {
            m: ["1m", "1m", "1m"].map((s) => new 牌(s)),
            p: [],
            s: [],
            z: ["1z", "1z", "1z"].map((s) => new 牌(s)),
        };
    ...
    test("面子 - 順子とれない - 字牌", () => {
        const 手牌 = {
            m: ["1m", "1m", "2m"].map((s) => new 牌(s)),
            p: [],
            s: [],
            z: ["1z", "2z", "3z"].map((s) => new 牌(s)),
        };
        const result = extractSingleブロック(手牌, "面子", { suit: "z", index: 0 });
        expect(result).toEqual({
            status: "failure",
...
//# sourceMappingURL=extractSingle%E3%83%96%E3%83%AD%E3%83%83%E3%82%AF.test.js.map